...
var svg, tree, zoom,
    ...
    headerHeight,
    config = {
        apiUrl: "/handlers/esud/get_graph_tree/",
        megaModelId: "5491520dad86960003f070ba",
        nodeHeight: 20,
        nodeLabelPadding: 11,
        nodeRadius: 5,
        soloOpacity: 0.2,
...
function showNodeButtons(d) {
    var radius = 17;
    var esudUrlTemplate = '/esud#c1__go__%parentId%&c1__activate__false&c1__highlight__&c1__expand__false&c2__go__%childId%&c2__activate__true&c2__highlight__&c2__expand__false';
    if (!nodeButtons) {
