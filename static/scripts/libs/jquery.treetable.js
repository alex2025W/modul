...
(function($) {
  ...
  Node = (function() {
    ...
    Node.prototype._getAllChildrenId = function() {
      var result  = [];
      result.push(this.id);
      if(this.children.length>0)
      {
        ...
        {
           var tmp_res = this.children[i]._getAllChildrenId();
           for(var j in tmp_res)
  ...
  methods = {
    ...
    loadBranch: function(node, rows) {
      ...
      rows.filter("tr").each(function() {
        tree[$(this).data(settings.nodeIdAttr)].show();
         //tree[$(this).data(settings.nodeIdAttr)].updateBranchLeafClass();
      });
    ...
    loadBranchOrigin: function(node, rows) {
      var settings = this.data("treetable").settings,
      tree = this.data("treetable").tree;
