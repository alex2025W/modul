d3 = function() {
  ...
  var d3_time_formatDateTime = "%A, %e %B %Y г. %X", d3_time_formatDate = "%d.%m.%Y", d3_time_formatTime = "%H:%M:%S";
  var d3_time_days = [ "воскресенье", "понедельник", "вторник", "среда", "четверг", "пятница", "суббота" ], d3_time_dayAbbreviations = [ "вс", "пн", "вт", "ср", "чт", "пт", "сб" ], d3_time_months = [ "январь", "февраль", "март", "апрель", "май", "июнь", "июль", "август", "сентябрь", "октябрь", "ноябрь", "декабрь" ], d3_time_monthAbbreviations = [ "янв", "фев", "мар", "апр", "май", "июн", "июл", "авг", "сен", "окт", "ноя", "дек" ];
