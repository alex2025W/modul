...
@route('/outgoing')
def outgoing():
    userlib.check_page_access("outgoing","r")
    return template('views/outgoing', current_user=userlib.get_cur_user(), version = config.VERSION, dicts=get_dictionary(False), users = get_users(), menu=userlib.get_menu())
