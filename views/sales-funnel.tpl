...
<script src="/static/scripts/libs/chartjs-plugin-datalabels@2.0.0.js?v={{version}}"></script>
<script src="/static/scripts/sales-funnel/app.js?v={{version}}"></script>
%end

%rebase master_page/base page_title='Воронка продаж', current_user=current_user, version=version, scripts=scripts, menu=menu
<style>
    h3 {
        font-size: 16px;
    }
