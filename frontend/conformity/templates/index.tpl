%def scripts():
  ...
  <link href="/frontend/conformity/styles/conformity.css?v={{version}}" rel="stylesheet" media="screen">
  <link href="/frontend/conformity/styles/edit_material.css?v={{version}}" rel="stylesheet" media="screen">
  <link href="/frontend/conformity/styles/search_material.css?v={{version}}" rel="stylesheet" media="screen">
  <script src="/frontend/conformity/scripts/app.js?v={{version}}"></script>
  ...
  <script src="/frontend/conformity/scripts/edit_material_form_container_view.js?v={{version}}"></script>
  <script src="/frontend/conformity/scripts/search_material_view.js?v={{version}}"></script>
...
%include frontend/conformity/templates/search_material_template
